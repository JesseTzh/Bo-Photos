...
import { Button, Card, Checkbox, Image, Space, Switch, Tag, Tooltip } from "antd";
    ...
    <Card
      ...
      actions={[
        ...
        asset.status === "deleted"
          ? <Tooltip title="恢复" key="restore"><Button type="text" icon={<UndoOutlined />} onClick={onRestore} /></Tooltip>
